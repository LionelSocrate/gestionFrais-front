...
import MenuStudent from "../components/etudiant/MenuStudent";
import AddStudentForm from "../components/etudiant/AddStudentForm";
import ListeStudent from "../components/etudiant/ListeStudent";
        ...
        <div className=" flex w-full h-full">
          ...
          <div className=" bg-[rgb(247,247,247)] w-full h-full ">
            <div className=" w-full grid grid-cols-7 gap-1  bg-white pb-1">
              ...
              <div
                className="  flex items-center gap-2  bg-orange-400 py-1 px-4  cursor-pointer rounded-sm"
